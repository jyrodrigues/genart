...
toSvg : Icon -> Svg msg
toSvg { path, size, fillColor, strokeColor, strokeWidth } =
    svg
        [ viewBox "0 0 100 100"
        ...
        [ Svg.path
            ...
            , Attrs.strokeWidth (String.fromInt strokeWidth)
            , strokeLinecap "round"
...
icon =
    ...
    , strokeWidth = 10 -- viewBox is 100x100
    }
...
iconTrash =
    { icon
        | path = "M25,29.26V24.07H37.5c-.52-3.1.34-6.13,2.27-7.77A5.54,5.54,0,0,1,43.18,15H58a5.84,5.84,0,0,1,2.28,1.3c2.8,2.6,2.33,7.3,2.27,7.77H75v5.19H70.45v48a9.17,9.17,0,0,1-1.13,3.89A7.94,7.94,0,0,1,63.64,85H37.5a8.19,8.19,0,0,1-6.82-3.89,9,9,0,0,1-1.13-3.89v-48Zm17-5.19H58a4.88,4.88,0,0,0,0-3.88,3.42,3.42,0,0,0-1.13-1.3H43.18a3.42,3.42,0,0,0-1.13,1.3A4.88,4.88,0,0,0,42.05,24.07ZM39.77,35.74V72h3.41V35.74Zm9.09,0V72h3.41V35.74Zm9.09,0V72h3.41V35.74Z"
        , strokeColor = Colors.transparent
        , fillColor = Colors.red_
    }
...
iconDelete =
    { icon
        | path = "M 75 25 L 25 75 M 25 25 L 75 75"
...
iconPen =
    { icon
        | path = "M29,64.23l13.16,10-13.88,10a3.59,3.59,0,0,1-5-5Zm3.35-4.78L45.48,69l22-30.62-13.16-10Q43.32,43.89,32.32,59.45Zm25.2-34.73L70.2,34.77l7.18-8.85c.05-.36.68-5.3-3.11-8.61A9.65,9.65,0,0,0,64,15.87Z"
    }
